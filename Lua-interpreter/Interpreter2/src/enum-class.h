...
#define ENUM_CLASS(TypeName, ...)                                   \
    ...
    template <> inline                                              \
    reflect_type<Reflector##TypeName>::type *         \
    get_reflector<Reflector##TypeName>()              \
    { static Reflector##TypeName reflector; return &reflector; }
    
    //CUA::Reflect::reflect_type<Reflector
    //CUA::Reflect::get_reflector
    
#define ERE(TypeName)   \
    (::CUA::get_reflector<Reflector##TypeName>())
